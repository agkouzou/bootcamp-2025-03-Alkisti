...
export default function AccountPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const profileRes = await axios.get(`${API_BASE_URL}/users/${uid}/profile-settings`, {
                    headers: { Authorization: `Bearer ${storedToken}` }
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`${API_BASE_URL}/users/${userId}/profile-settings`, profileData, {
                headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json" }
            });
    ...
    return (
        <>
            <Head>
                <title>Account Settings - AI Chat App</title>
            ...
            <div className="page-container">
                <header>
                    <div className="header-content">
                        <div className="header-brand">
                            ...
                            <div className="header-title">AI Chat App</div>
                        </div>
                ...
                <div className="content">
                    <div className="account-settings">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group">
                                <label htmlFor="intro">Customize AI Chat App</label>
                            ...
                            <div className="form-group">
                                <label htmlFor="nickname">What should AI Chat App call you?</label>
                            ...
                            <div className="form-group">
                                <label>What traits should AI Chat App have?</label>
                            ...
                            <div className="form-group">
                                <label htmlFor="notes">Anything else AI Chat App should know about you?</label>
                ...
                <footer>© 2025 AI Chat App, Inc.</footer>
            </div>
        </>
    );
}